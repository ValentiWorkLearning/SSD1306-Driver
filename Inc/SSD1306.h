...
static uint8_t SSD1306_dispBuffer[SSD1306_DISP_SIZE], *SSD1306_pDispBuffer =
        SSD1306_dispBuffer;
...
typedef enum
{
    SSD1306_BLACK = 0x00, SSD1306_WHITE = 0x01
} SSD1306_Colors;
...
void
ssd1306_drawCircle (int16_t x0, int16_t y0, int16_t r, SSD1306_Colors _color);
